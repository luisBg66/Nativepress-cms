...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($titulo)) {
        ...
        if (empty($error)) {
            ...
            $stmt->execute([$titulo, $slug, $contenido, $imagen_portada, $publicado]);
            $exito = 'Artículo creado correctamente.';
        }
    }
}
?>
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="imagen_portada" class="form-control" accept=".jpg,.jpeg,.png,.webp">
                    </div>
